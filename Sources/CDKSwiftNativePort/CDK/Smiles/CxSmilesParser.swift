    ...
    public static func applyAtomLabels(to molecule: inout Molecule, state: CDKCxSmilesState) {
        ...
        for (atomIndex, label) in state.atomLabels {
            ...
            molecule.atoms[idx] = Atom(id: existing.id,
                                       ...
                                       atomList: existing.atomList,
                                       atomListIsNegated: existing.atomListIsNegated,
                                       radical: existing.radical,
                                       rGroupLabel: existing.rGroupLabel,
                                       substitutionCount: existing.substitutionCount,
                                       unsaturated: existing.unsaturated,
                                       ringBondCount: existing.ringBondCount,
                                       attachmentPoint: existing.attachmentPoint,
                                       atomClass: existing.atomClass,
                                       atomMapNumber: existing.atomMapNumber)
        }
    }
